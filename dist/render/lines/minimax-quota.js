...
export function renderMiniMaxQuotaLine(ctx) {
...
function formatWindowPart({ label: windowLabel, percent, remaining, total, resetAt, colors, barEnabled, barWidth, }) {
...
//# sourceMappingURL=minimax-quota.js.map